...
from ventasCayambe.models import VentasCayambe
...
class generarPagoCayambe(models.Model):
    ...
    venta = models.ForeignKey(VentasCayambe, null=True, blank=True, on_delete=models.SET_NULL)

    class Meta:
        db_table = 'genera_pago_cayambe'
