...
export function VentasMiraForm() {
  ...
  const onSubmit = handleSubmit(async (data) => {
    if (params.id) {
      await updateVentasMira(params.id, data);
    } else {
      await creatVentasMira(data);
    }
  ...
  useEffect(() => {
    async function actualizarProducto() {
      if (params.id) {
        const { data } = await getVentaMira(params.id);
        ...
        const clienteSeleccionado = clientesMira.find(
    ...
    actualizarProducto();
  }, [params.id, clientesMira, inventarios]);
  ...
  return (
    <div className="container mt-3">
      ...
      <div className="d-flex justify-content-between align-items-center mb-4">
          <Link to="/ventasMira" className="fs-3">
            <i className="bi bi-arrow-left-circle-fill"></i>
          </Link>
          <div className="flex-grow-1 d-flex justify-content-center">
            <h1 className="titulos">Ingrese su venta Clientes Mira</h1>
          </div>
        ...
        <div className="col-md-3">
          ...
          <Select
            ...
            options={clientesMira.map((cliente) => ({
              value: cliente.id,
