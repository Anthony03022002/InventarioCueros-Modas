...
import {
  creatVentasPimampiro,
  deleteVentasPimampiro,
  updateVentasPimampiro,
  getVentaPimampiro,
} from "../api/ventasPimampiro.api";
import { useNavigate, useParams, Link } from "react-router-dom";
import { createVentasHistorial } from "../api/ventasHistorial.api";

export function VentasPimampiroForm() {
  ...
  const handleDelete = async () => {
    await deleteVentasPimampiro(params.id);
    navigate("/ventasPimampiro");
  };
  ...
  useEffect(() => {
    async function actualizarProducto() {
      if (params.id) {
        const { data } = await getVentaPimampiro(params.id);
        ...
        const clienteSeleccionado = clientesPimampiro.find(
    ...
    actualizarProducto();
  }, [params.id, clientesPimampiro, inventarios]);
      ...
      >
        <div className="d-flex justify-content-between align-items-center mb-4">
          ...
          <div className="flex-grow-1 d-flex justify-content-center">
            <h1 className="titulos">Ingrese su venta Clientes Pimampiro</h1>
          </div>
        ...
        <div className="col-md-3">
          ...
          <Select
            ...
            options={clientesPimampiro.map((cliente) => ({
              value: cliente.id,
