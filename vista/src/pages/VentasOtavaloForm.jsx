...
export function VentasOtavaloForm() {
  ...
  const onSubmit = handleSubmit(async (data) => {
    if (params.id) {
      await updateVentasOtavalo(params.id, data);
    } else {
      await creatVentasOtavalo(data);
  ...
  const handleDelete = async () => {
    await deleteVentasOtavalo(params.id);
    navigate("/ventasOtavalo");
  };
  ...
  useEffect(() => {
    async function actualizarProducto() {
      if (params.id) {
        const { data } = await getVentaOtavalo(params.id);
    ...
    actualizarProducto();
  }, [params.id, clientesOtavalo, inventarios]);
    ...
    <div className="container mt-3">
      ...
      >
        <div className="d-flex justify-content-between align-items-center mb-4">
          <Link to="/ventasOtavalo" className="fs-3">
            <i className="bi bi-arrow-left-circle-fill"></i>
          </Link>
          <div className="flex-grow-1 d-flex justify-content-center">
            <h1 className="titulos">Ingrese su venta Clientes Otavalo</h1>
          </div>
        ...
        <div className="col-md-3">
          ...
          <Select
            ...
            options={clientesOtavalo.map((cliente) => ({
              value: cliente.id,
