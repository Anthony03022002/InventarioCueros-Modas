...
export function VentasBolivarForm() {
  ...
  const onSubmit = handleSubmit(async (data) => {
    if (params.id) {
      await updateVentasBolivar(params.id, data);
    } else {
      await creatVentasBolivar(data);
  ...
  const handleDelete = async () => {
    await deleteVentasBolivar(params.id);
    navigate("/ventasBolivar");
  };
  ...
  useEffect(() => {
    async function actualizarProducto() {
      if (params.id) {
        const { data } = await getVentaBolivar(params.id);
        ...
        const clienteSeleccionado = clientesBolivar.find(
    ...
    actualizarProducto();
  }, [params.id, clientesBolivar, inventarios]);
  ...
  return (
    <div className="container mt-3">
      ...
      <div className="d-flex justify-content-between align-items-center mb-4">
          <Link to="/ventasBolivar" className="fs-3">
            <i className="bi bi-arrow-left-circle-fill"></i>
          </Link>
          <div className="flex-grow-1 d-flex justify-content-center">
            <h1 className="titulos">Ingrese su venta Clientes Bolivar</h1>
          </div>
        ...
        <div className="col-md-3">
          ...
          <Select
            ...
            options={clientesBolivar.map((cliente) => ({
              value: cliente.id,
