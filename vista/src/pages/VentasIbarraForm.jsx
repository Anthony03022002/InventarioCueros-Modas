...
export function VentasIbarraForm() {
  ...
  const handleDelete = async () => {
    await deleteVentasIbarra(params.id);
    navigate("/ventasIbarra");
  };
  ...
  useEffect(() => {
    async function actualizarProducto() {
      if (params.id) {
        const { data } = await getVentaIbarra(params.id);
    ...
    actualizarProducto();
  }, [params.id, clientesIbarra, inventarios]);
      ...
      >
        <div className="d-flex justify-content-between align-items-center mb-4">
          ...
          <div className="flex-grow-1 d-flex justify-content-center">
            <h1 className="titulos">Ingrese su venta Clientes Ibarra</h1>
          </div>
        ...
        <div className="col-md-3">
          ...
          <Select
            ...
            options={clientesIbarra.map((cliente) => ({
              value: cliente.id,
