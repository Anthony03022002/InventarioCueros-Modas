...
import {
  creatVentasAtuntaqui,
  deleteVentasAtuntaqui,
  updateVentasAtuntaqui,
  getVentaAtuntaqui,
} from "../api/ventasAtuntaqui.api";
import { useNavigate, useParams, Link } from "react-router-dom";
import { createVentasHistorial } from "../api/ventasHistorial.api";

export function VentasAtuntaquiForm() {
  ...
  const onSubmit = handleSubmit(async (data) => {
    if (params.id) {
      await updateVentasAtuntaqui(params.id, data);
    } else {
      await creatVentasAtuntaqui(data);
    }
  ...
  return (
    <div className="container mt-3">
      ...
      <Link to='/ventasAtuntaqui' className="fs-3"><i className="bi bi-arrow-left-circle-fill"></i></Link>
        <h1 className="titulos">Ingrese su venta Clientes Atuntaqui</h1>
        <div className="col-md-3">
          ...
          <Select
            ...
            options={clientesAtuntaqui.map((cliente) => ({
              value: cliente.id,
