...
import { getAllPagosPimampiro, deletePagosPimampiro, updatePagosPimampiro } from "../api/generarPagoPimampiro.api"; // Importa las funciones de eliminar y actualizar
import Select from "react-select";

export function ClientePimampiroProducto() {
  ...
  return (
    <div className="container mt-4">
      <h2 className="text-center titulos">Resumen de Clientes Pimampiro</h2>
