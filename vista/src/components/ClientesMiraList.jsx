...
export function ClientesMiraList() {
  ...
  const filteredClientes = clientesMira.filter((cliente) =>
  ...
  return (
    <div className="container pt-4">
      <h1 className="titulos">CLIENTES MIRA</h1>
      <div className="d-flex justify-content-between align-items-center mb-3">
        ...
        <Link to="/crear-clienteMira" className="btn btn-primary">
          ...
          {currentClientes.map((cliente) => (
            <tr key={cliente.id}>
              ...
              <td>
                <button
                  onClick={()=>{
                    navigate(`/clientesMira/${cliente.id}`)
                  }}
