...
export function ClientesAtuntaquiList() {
  ...
  const filteredClientes = clientesAtuntaqui.filter((cliente) =>
  ...
  return (
    <div className="container pt-4">
      <h1 className="titulos">CLIENTES ATUNTAQUI</h1>
      <div className="d-flex justify-content-between align-items-center mb-3">
        ...
        <Link to="/crear-clienteAtuntaqui" className="btn btn-primary">
          ...
          {currentClientes.map((cliente) => (
            <tr key={cliente.id}>
              ...
              <td>
                <button
                  onClick={()=>{
                    navigate(`/clientesAtuntaqui/${cliente.id}`)
                  }}
