...
export function ClientesPimampiroList() {
  ...
  const filteredClientes = clientesPimampiro.filter((cliente) =>
  ...
  return (
    <div className="container pt-4">
      <h1 className="titulos">CLIENTES PIMAMPIRO</h1>
      <div className="d-flex justify-content-between align-items-center mb-3">
        ...
        <Link to="/crear-clientePimampiro" className="btn btn-primary">
          ...
          {currentClientes.map((cliente) => (
            <tr key={cliente.id}>
              ...
              <td>
                <button
                  onClick={()=>{
                    navigate(`/clientesPimampiro/${cliente.id}`)
                  }}
